...
export default function CustomerLogin({ onNext, onSwitchToAdmin, onSwitchToUser }: CustomerLoginProps) {
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              ...
              className="w-full h-12 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white rounded-xl shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              Login Securely as Customer
            </Button>

...
export default function AdminLogin({ onNext, onSwitchToUser, onSwitchToCustomer, onCreateAccount, onForgotPassword }: AdminLoginProps) {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <button
                ...
                className="text-[#0F9D58] text-sm hover:underline mt-1"
              >
                Forgot Password?
              </button>
            </div>
            ...
            <Button 
              ...
              className="w-full h-12 bg-gradient-to-r from-[#0F9D58] to-[#0d8a4d] hover:from-[#0d8a4d] hover:to-[#0b7a43] text-white rounded-xl shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >

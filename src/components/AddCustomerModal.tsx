...
interface AddCustomerModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: (customer: { id: string; name: string; phone: string; email: string }) => void;
}
...
export default function AddCustomerModal({ open, onClose, onSuccess }: AddCustomerModalProps) {
  ...
  const generateCustomerId = (fullName: string): string => {
      ...
      <DialogContent className="max-w-md">
        {step === 'form' ? (
          ...
          <div className="text-center py-4">
            ...
            <h2 className="text-gray-900 mb-2">Customer Created Successfully!</h2>
            <div className="bg-gray-50 rounded-2xl p-4 mb-6">
              <div className="text-gray-500 text-sm mb-1">Customer ID</div>
